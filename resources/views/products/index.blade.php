                    ...
                    @else
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border border-blue-200">
                            ...
                            <div class="px-1 py-4">
                                ...
                                @endguest
                                @auth
                                <form class="py-4" method="POST" action="{{ route('reservations.store', ['product' => $product->id]) }}">
                                    <input class=class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="number" placeholder="Quantity" value="1" min="1" max="{{ $product->quantity }}"/>
